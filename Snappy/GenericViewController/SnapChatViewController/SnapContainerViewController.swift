...
class SnapContainerViewController: UIViewController, UIScrollViewDelegate {
    ...
    class func containerViewWith(_ leftViewController: UIViewController, middleViewController: UIViewController, rightViewController: UIViewController, topViewController: UIViewController) -> SnapContainerViewController {
        let container = SnapContainerViewController()
        
        container.directionLockDisabled = false
        
        container.leftVc = leftViewController
        container.middleVc = middleViewController
        container.rightVc = rightViewController
        container.topVc = topViewController
